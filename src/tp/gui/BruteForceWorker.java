...
public class BruteForceWorker extends SwingWorker<List<Employee>, Void> {
	...
	public BruteForceWorker(List<Employee> employees, int projectLeaderCount, int architectCount, int programmerCount,
			int testerCount) {
	...
	protected List<Employee> doInBackground() throws Exception {
		...
		List<Employee> bestCombination = idealTeam.generateTeamByBruteForce(employees, projectLeaderCount,
