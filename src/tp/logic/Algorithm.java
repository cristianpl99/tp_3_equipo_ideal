...
public abstract class Algorithm {
	...
	protected double combinationCount;
	protected long executionTime;

	public Algorithm(List<Employee> employees, int projectLeaderCount, int architectCount, int programmerCount,
			int testerCount) {
	...
	protected abstract void generateCombination(List<Employee> combination, int currentIndex);
